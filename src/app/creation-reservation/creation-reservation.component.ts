...
cur = new InfoVehicule(undefined,undefined,undefined,undefined,undefined,undefined);
...
ajouterReservation(){
  this.reservation = new ReservationVehicule(
    ...
    `${this.dateDeRetour}${this.t}${this.heureDeRetour}${this.deuxPoints}${this.minutesDeretour}${this.deuxPoints}${this.secondes}`, this.cur)
 return this._srv.reservationAjouter(this.reservation).subscribe(col => { }, err => {}, () => {
